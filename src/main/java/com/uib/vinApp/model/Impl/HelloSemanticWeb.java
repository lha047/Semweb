...
//	}
	...
	public List<String> runQuery(String query) {
		...
		QueryExecution qexec = runWine(query, getModel());
	...
	/* (non-Javadoc)
	 * @see com.uib.vinApp.Interface.ISemanticWeb#hentVareInfo(java.lang.String)
	 */
	@Override
	...
	private IDBpedia finnDBPediaOmLand(String land) {
		...
		String artikkel = "artikkel";
		IDBpedia dbp = new DBPediaImpl(tittel, artikkel);
		return null;
	}


	private String finnVareLand(String vare) {
		//kjør spørring for å finne hvor varen kommer fra
		String land = "vare";
		return land;
	}
}
